...
public interface BaseDao<T> {
	...
	public int countBySql(List param,String sql);
	...
	public Pager getForPagerBySql(Class clss, String sql, PageParam page, Object... param);
	...
	public Pager<List<Map<String, Object>>> getForPagerBySql(String sql, List param, PageParam page);
