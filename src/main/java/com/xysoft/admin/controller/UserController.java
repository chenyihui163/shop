...
public class UserController {
	    ...
	    public String data(HttpServletResponse response, HttpServletRequest request,PageParam page
	    		...
	    		throws Exception{
		    String res = this.userService.toData(page, keyword);
	    ...
	    public ModelAndView edit(HttpServletResponse response, HttpServletRequest request,
	    		 @RequestParam(defaultValue = "") String yhxxid)
	    		throws Exception{
	    	Map<String, Object> model = this.userService.editUser(yhxxid);
			return new ModelAndView(model.get("model").toString(), RequestUtil.initFrontMap(model));
	    }
	    ...
	    public String save(HttpServletResponse response, HttpServletRequest request,
	    		TFitYhxx tFitYhxx)
	    		throws Exception{
		    String res = this.userService.saveUser(tFitYhxx);
		    response.getWriter().write(res);
		    return null;
	    }
	    ...
	    public String delete(HttpServletResponse response, HttpServletRequest request,
	    		 @RequestParam(defaultValue = "") String yhxxid)
	    		throws Exception{
		    String res = this.userService.deleteUser(yhxxid);
		    response.getWriter().write(res);
		    return null;
	    }
