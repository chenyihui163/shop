            ...
            function a(t, i, n) {
                ...
                return u(n, function(n, c) {
                    c > 0 && u(n, function(n, u) {
                        ...
                        return n === r || t && s[u] === r ? !0 : (c && i && (n = o(n)),
        ...
        n("moxie/core/utils/Encode", [], function() {
            var e = function(e) {
              ...
              , i = function(e, i) {
                ...
                while (m < e.length);return f = p.join(""),
                i ? t(f) : f
            }
              , n = function(t, i) {
                if (i && (t = e(t)),
            ...
            function h() {
                ...
                function u(t) {
                    ...
                    function r(r) {
                        ...
                        R.bind("Load", function(t) {
                            i("readyState", h.DONE),
                            i("status", Number(r.exec.call(R, "XMLHttpRequest", "getStatus") || 0)),
                            i("statusText", f[i("status")] || ""),
                            i("response", r.exec.call(R, "XMLHttpRequest", "getResponse", i("responseType"))),
                            ~e.inArray(i("responseType"), ["text", ""]) ? i("responseText", i("response")) : "document" === i("responseType") && i("responseXML", i("response")),
                            U = r.exec.call(R, "XMLHttpRequest", "getAllResponseHeaders"),
                            s.dispatchEvent("readystatechange"),
                    ...
                    k.ruid ? r(R.connectRuntime(k)) : (R.bind("RuntimeInit", function(e, t) {
                        r(t)
                    }),
                ...
                e.extend(this, I, {
                    ...
                    getResponseHeader: function(t) {
                        ...
                        F || ~e.inArray(t, ["set-cookie", "set-cookie2"]) ? null : U && "" !== U && (_ || (_ = {},
                        e.each(U.split(/\r\n/), function(t) {
                            var i = t.split(/:\s+/);
                    ...
                    destroy: function() {
                        R && ("function" === e.typeOf(R.destroy) && R.destroy(),
                        R = null),
                        this.unbindAll(),
                ...
                t.extend(this, {
                    ...
                    getAsBinaryString: function(e, t) {
                        ...
                        if ("image/jpeg" !== e)
                            ...
                            R && (x.meta && x.meta.exif && x.setExif({
            ...
            function c(u) {
                ...
                e.extend(this, {
                    ...
                    init: function() {
                        ...
                        i += 'width="100%" height="100%" style="outline:0"><param name="movie" value="' + u.swf_url + '" />' + '<param name="flashvars" value="uid=' + escape(this.uid) + "&target=" + t.global_event_dispatcher + '" />' + '<param name="wmode" value="transparent" />' + '<param name="allowscriptaccess" value="always" />' + "</object>",
            ...
            function s(s) {
                ...
                e.extend(this, {
                    ...
                    init: function() {
                        ...
                        e.innerHTML = '<object id="' + this.uid + '" data="data:application/x-silverlight," type="application/x-silverlight-2" width="100%" height="100%" style="outline:none;">' + '<param name="source" value="' + s.xap_url + '"/>' + '<param name="background" value="Transparent"/>' + '<param name="windowless" value="true"/>' + '<param name="enablehtmlaccess" value="true"/>' + '<param name="initParams" value="uid=' + this.uid + ",target=" + t.global_event_dispatcher + '"/>' + "</object>",
            ...
            function s() {
                ...
                i.extend(this, {
                    init: function(t) {
                        ...
                        u = t,
                        l = t.accept.mimes || o.extList2mimes(t.accept, s.can("filter_by_extension")),
    ...
    !function(e, t, i) {
        ...
        l.Uploader = function(e) {
            function a() {
                ...
                if (this.state == l.STARTED) {
                    for (t = 0; t < x.length; t++)
                        e || x[t].status != l.QUEUED ? i++ : (e = x[t],
                        this.trigger("BeforeUpload", e) && (e.status = l.UPLOADING,
                        this.trigger("UploadFile", e)));
                    i == x.length && (this.state !== l.STOPPED && (this.state = l.STOPPED,
            ...
            function d() {
                ...
                e = 0; e < x.length; e++)
                    t = x[e],
                    t.size !== i ? (w.size += t.origSize,
                    n = t.loaded * t.origSize / t.size,
                    (!t.completeTimestamp || t.completeTimestamp > I) && (r += n),
                    w.loaded += n) : w.size = i,
                    t.status == l.DONE ? w.uploaded++ : t.status == l.FAILED ? w.failed++ : w.queued++;
                w.size === i ? w.percent = x.length > 0 ? Math.ceil(100 * (w.uploaded / x.length)) : 0 : (w.bytesPerSec = Math.ceil(r / ((+new Date - I || 1) / 1e3)),
                w.percent = w.size > 0 ? Math.ceil(100 * (w.loaded / w.size)) : 0)
            }
            function c() {
                var e = U[0] || F[0];
                ...
                e.browse_button && l.each(e.browse_button, function(i) {
                    s.push(function(s) {
                        ...
                        u.bind("mouseenter mouseleave mousedown mouseup", function(t) {
                            A || (e.browse_button_hover && ("mouseenter" === t.type ? l.addClass(i, e.browse_button_hover) : "mouseleave" === t.type && l.removeClass(i, e.browse_button_hover)),
            ...
            function h(e, n, r) {
                ...
                try {
                    s.onload = function() {
                        return n.width > this.width && n.height > this.height && n.quality === i && n.preserve_headers && !n.crop ? (this.destroy(),
                        r(e)) : (s.downsize(n.width, n.height, n.crop, n.preserve_headers),
                        void 0)
                    }
                    ,
                    s.onresize = function() {
            ...
            function m(e, i, r) {
                ...
                r ? (S.required_features = n(l.extend({}, S)),
                P = n(l.extend({}, S, {
                    required_features: !0
                }))) : u && (a.trigger("Destroy"),
            ...
            function E(e, i) {
                ...
                function s() {
                    ...
                    d && p.chunks && o.size > d ? (n = Math.min(d, o.size - g),
                    t = o.slice(g, g + n)) : (n = o.size,
                    t = o),
                    d && p.chunks && (e.settings.send_chunk_number ? (r.chunk = Math.ceil(g / d),
                    r.chunks = Math.ceil(o.size / d)) : (r.offset = g,
                    r.total = o.size)),
                ...
                function a(a, d, f) {
                    ...
                    T.onload = function() {
                        ...
                        d = h = null,
                        !g || g >= o.size ? (i.size != i.origSize && (o.destroy(),
                        o = null),
                        e.trigger("UploadProgress", i),
                        i.status = l.DONE,
                    ...
                    ,
                    e.settings.multipart && p.multipart ? (T.open(e.settings.http_method, u, !0),
                    ...
                    })) : (u = l.buildUrl(e.settings.url, l.extend(a, e.settings.multipart_params)),
                ...
                o = i.getSource(),
                !l.isEmptyObj(e.settings.resize) && f(o, "send_binary_string") && -1 !== l.inArray(o.type, ["image/jpeg", "image/png"]) ? h.call(this, o, e.settings.resize, function(e) {
                    o = e,
                    i.size = e.size,
                    s()
                }) : s()
