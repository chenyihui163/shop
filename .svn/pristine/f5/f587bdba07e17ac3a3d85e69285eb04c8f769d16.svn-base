...
import com.xysoft.util.Base64Util;
...
public class UploadServiceImpl implements UploadService {
	...
	public String uploadFile(HttpServletRequest request) {
		...
		extMap.put(ElementConst.Ext_File, "doc,docx,xls,xlsx,ppt,htm,html,txt,zip,rar,gz,bz2,tif,pps,ppt,pptx,gif,jpg,jpeg,png,bmp,swf,flv,swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb,zip,rar");
		//最大文件大小
	...
	public String saveBase64Image(String base64) {
		if(NullUtils.isEmpty(base64)) return JsonUtil.toResOfFail("base64字符串不能为空");
		...
		String saveUrl  = FileUtil.speratorAnti 
				+ ElementConst.File_Target_Dir + FileUtil.speratorAnti + ElementConst.File_Save_Dir;
		String newFileName = CommonUtil.getUUID() + ".jpg";
		String dirName = ElementConst.Ext_Image;
		...
		Base64Util.decodeBase64ToImage(base64, savePath, newFileName);
		
		return JsonUtil.toRes("上传成功", saveUrl + newFileName);
	}
