...
public class PaymentServiceImpl implements PaymentService {
	...
	public String payment(HttpServletRequest request) throws IOException {
	   ...
	   String timeout_express="2m";
		...
		return alipaychannel(out_trade_no,subject,total_amount,body,timeout_express,product_code);
	}

	private String alipaychannel(String out_trade_no,String subject,
			String total_amount,String body,String timeout_express,
			String product_code) throws IOException {
